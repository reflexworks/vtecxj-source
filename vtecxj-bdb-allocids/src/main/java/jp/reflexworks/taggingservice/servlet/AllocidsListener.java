...
import jp.reflexworks.taggingservice.env.AllocidsEnv;
import jp.reflexworks.taggingservice.exception.StaticDuplicatedException;

/**
 * サーバ起動、シャットダウン時のリスナー.
 */
public class AllocidsListener implements ServletContextListener {
	...
	public void contextInitialized(ServletContextEvent sce) {
		...
		AllocidsEnv env = new AllocidsEnv(contextUtil);
		try {
