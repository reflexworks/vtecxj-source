...
import jp.reflexworks.taggingservice.servlet.AllocidsRequest;
 ...
 * リクエストパラメータ情報
 */
public class AllocidsRequestParam implements RequestType {
	 ...
	 * @param req リクエスト
	 */
	public AllocidsRequestParam(AllocidsRequest req) {
		// URI抽出
