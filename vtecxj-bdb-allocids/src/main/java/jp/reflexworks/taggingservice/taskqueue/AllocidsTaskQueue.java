 ...
 * 例外発生時の処理を共通化する。
 */
public class AllocidsTaskQueue<T> implements ReflexTaskQueue<T> {
	 ...
	 */
	public AllocidsTaskQueue(ReflexBDBCallable<T> callable, String serviceName,
	...
	public T call() throws IOException, TaggingException {
		...
		try {
			...
			// ReflexContext生成
			AllocidsContext reflexContext = new AllocidsContext(
