...
import jp.reflexworks.taggingservice.env.FullTextSearchEnv;
import jp.reflexworks.taggingservice.exception.StaticDuplicatedException;

/**
 * APサーバ起動、シャットダウン時のリスナー.
 */
public class FullTextSearchListener implements ServletContextListener {
	...
	public void contextInitialized(ServletContextEvent sce) {
		...
		FullTextSearchEnv env = new FullTextSearchEnv(contextUtil);
		try {
