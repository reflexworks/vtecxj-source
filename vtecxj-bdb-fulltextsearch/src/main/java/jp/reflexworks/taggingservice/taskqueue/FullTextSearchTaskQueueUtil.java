 ...
 * 非同期処理ユーティリティ.
 */
public class FullTextSearchTaskQueueUtil {
	...
	public static Future<?> addTask(ReflexBDBCallable<?> callable,
			long countdownMillis, String serviceName, String namespace, String sid,
	...
	throws IOException, TaggingException {
		...
		FullTextSearchTaskQueue<?> taskQueue = new FullTextSearchTaskQueue(callable,
				serviceName, namespace, sid, requestInfo);
