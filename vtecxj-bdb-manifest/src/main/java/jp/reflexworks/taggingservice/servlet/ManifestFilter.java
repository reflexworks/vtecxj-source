 ...
 * BDBマニフェストサーブレットフィルタ
 */
public class ManifestFilter implements Filter, ReflexServletConst {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
		...
		// リクエスト・レスポンスをラップ
		ManifestRequest req = new ManifestRequest(httpReq);
		ManifestResponse resp = new ManifestResponse(req, httpResp);
	 ...
	 * @param req リクエスト
	 */
	private void checkRequest(ManifestRequest req) {
