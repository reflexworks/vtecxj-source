...
import jp.reflexworks.taggingservice.env.ManifestEnv;
import jp.reflexworks.taggingservice.exception.StaticDuplicatedException;

/**
 * サーバ起動、シャットダウン時のリスナー.
 */
public class ManifestListener implements ServletContextListener {
	...
	public void contextInitialized(ServletContextEvent sce) {
		...
		ManifestEnv env = new ManifestEnv(contextUtil);
		try {
