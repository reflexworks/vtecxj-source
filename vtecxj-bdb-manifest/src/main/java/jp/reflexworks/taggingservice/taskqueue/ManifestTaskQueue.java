 ...
 * 例外発生時の処理を共通化する。
 */
public class ManifestTaskQueue<T> implements ReflexTaskQueue<T> {
	 ...
	 */
	public ManifestTaskQueue(ReflexBDBCallable<T> callable, String serviceName,
	...
	public T call() throws IOException, TaggingException {
		...
		try {
			...
			// ReflexContext生成
			ManifestContext reflexContext = new ManifestContext(
