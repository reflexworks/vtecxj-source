...
import jp.reflexworks.taggingservice.servlet.ManifestRequest;
 ...
 * リクエストパラメータ情報
 */
public class ManifestRequestParam implements RequestType {
	 ...
	 * @param req リクエスト
	 */
	public ManifestRequestParam(ManifestRequest req) {
		// URI抽出
