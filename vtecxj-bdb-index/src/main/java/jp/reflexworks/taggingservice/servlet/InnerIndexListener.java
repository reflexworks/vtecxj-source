...
import jp.reflexworks.taggingservice.env.InnerIndexEnv;
import jp.reflexworks.taggingservice.exception.StaticDuplicatedException;

/**
 * サーバ起動、シャットダウン時のリスナー.
 */
public class InnerIndexListener implements ServletContextListener {
	...
	public void contextInitialized(ServletContextEvent sce) {
		...
		InnerIndexEnv env = new InnerIndexEnv(contextUtil);
		try {
