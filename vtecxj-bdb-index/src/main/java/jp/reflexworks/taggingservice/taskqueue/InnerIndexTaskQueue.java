 ...
 * 例外発生時の処理を共通化する。
 */
public class InnerIndexTaskQueue<T> implements ReflexTaskQueue<T> {
	 ...
	 */
	public InnerIndexTaskQueue(ReflexBDBCallable<T> callable, String serviceName,
	...
	public T call() throws IOException, TaggingException {
		...
		try {
			...
			// ReflexContext生成
			InnerIndexContext reflexContext = new InnerIndexContext(
