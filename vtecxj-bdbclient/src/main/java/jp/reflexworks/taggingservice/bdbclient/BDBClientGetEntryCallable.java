 ...
 * Entry取得処理.
 */
public class BDBClientGetEntryCallable extends ReflexCallable<EntryBase> {
	 ...
	 */
	public BDBClientGetEntryCallable(String uri, boolean useCache) {
		this.uri = uri;
	...
	public EntryBase call() throws IOException, TaggingException {
		...
		try {
			...
			return retrieveManager.getEntry(uri, useCache,
