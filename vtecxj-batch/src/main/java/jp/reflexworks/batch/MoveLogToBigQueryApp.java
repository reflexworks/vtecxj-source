 ...
 */
public class MoveLogToBigQueryApp {
	...
	/** ビジネスロジッククラス名 */
	public static final String CLASS_NAME = "jp.reflexworks.batch.MoveLogToBigQueryBlogic";
	
	/** テスト名 */
	public static final String APP_NAME = "[MoveLogToBigQueryApp]";
	
	/** ロガー. */
	private static Logger logger = LoggerFactory.getLogger(MoveLogToBigQueryApp.class);
